...
class PhoneDetectorTracker:
    def __init__(self, video_path, confidence_threshold=0.1, display_output=True):
        """
        ...
        self.model = YOLO('/Users/amansubash/Downloads/mp.pt')
        
        # Initialize DeepSORT tracker
        logger.info("Initializing DeepSORT tracker...")
        self.tracker = DeepSort(
            max_age=40,            # Keep track of disappeared objects for 30 frames
    ...
    def run(self):
        ...
        try:
            ...
            while True:
                ...
                cv2.putText(
                    processed_frame,
                    f"Missing People in frame: {active_tracks}",
                    (10, 30),
                    cv2.FONT_HERSHEY_SIMPLEX,
                    1,
                    (0, 255, 0),
...
def main():
    # Configuration
    CONFIG = {
        'VIDEO_PATH': '/Users/amansubash/Downloads/missing_person_3.mp4',
